...
#
# Script generated by Vivado on Mon Dec 15 20:02:55 +0800 2025
...
#
# Usage        : pclk.sh
#                pclk.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pclk.sh [-reset_run]
#                pclk.sh [-reset_log]
#                pclk.sh [-help]
#
...
#                script (type 'pclk.sh -help' for more information).
#
...
# script info
echo -e "pclk.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pclk.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pclk xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pclk -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pclk_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: pclk.sh [-reset_log]\n\
Usage: pclk.sh [-keep_index]\n\
