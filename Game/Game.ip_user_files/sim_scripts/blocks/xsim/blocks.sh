...
#
# Script generated by Vivado on Mon Dec 15 20:29:12 +0800 2025
...
#
# Usage        : blocks.sh
#                blocks.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blocks.sh [-reset_run]
#                blocks.sh [-reset_log]
#                blocks.sh [-help]
#
...
# script info
echo -e "blocks.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blocks.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blocks xil_defaultlib.blocks xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blocks -key {Behavioral:sim_1:Functional:blocks} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blocks.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blocks.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blocks.sh [-help]\n\
Usage: blocks.sh [-step]\n\
Usage: blocks.sh [-lib_map_path]\n\
Usage: blocks.sh [-reset_run]\n\
Usage: blocks.sh [-reset_log]\n\
Usage: blocks.sh [-keep_index]\n\
Usage: blocks.sh [-noclean_files]\n\n\
