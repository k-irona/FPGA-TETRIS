...
#
# Script generated by Vivado on Mon Dec 15 20:59:36 +0800 2025
...
# script info
echo -e "VRAM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot VRAM xil_defaultlib.VRAM xil_defaultlib.glbl -log elaborate.log
}
