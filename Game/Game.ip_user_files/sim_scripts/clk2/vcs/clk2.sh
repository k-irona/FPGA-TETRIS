...
#
# Script generated by Vivado on Thu Dec 18 15:44:02 +0800 2025
...
#
# Usage        : clk2.sh
#                clk2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk2.sh [-reset_run]
#                clk2.sh [-reset_log]
#                clk2.sh [-help]
#
...
#                script (type 'clk2.sh -help' for more information).
#
...
# script info
echo -e "clk2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk2 xil_defaultlib.glbl -o clk2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk2.sh [-help]\n\
Usage: clk2.sh [-step]\n\
Usage: clk2.sh [-lib_map_path]\n\
Usage: clk2.sh [-reset_run]\n\
Usage: clk2.sh [-reset_log]\n\
Usage: clk2.sh [-keep_index]\n\
Usage: clk2.sh [-noclean_files]\n\n\
